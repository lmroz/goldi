...
func Example() {
	yamlInput := `
		types:
			logger:
				package: github.com/lmroz/goldi-example/lib
				type: SimpleLogger
			...
			time.clock:
				package: github.com/lmroz/goldi-example/lib/mytime
				type: Clock
	...
	outputPackageName := "github.com/lmroz/goldi-example/lib"
	...
	// 	"github.com/lmroz/goldi-example/lib/mytime"
	...
	// // See https://github.com/lmroz/goldi for what is going on here.
